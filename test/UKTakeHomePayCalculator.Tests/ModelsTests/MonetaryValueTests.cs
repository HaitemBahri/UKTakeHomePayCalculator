...
public class MonetaryValueTests
{
    ...
    public static TheoryData<MonetaryValue, MonetaryValue, string> ShouldNegateValue_WhenPrecededWithNegativeSignTheoryData =>
        new()
        {
    ...
    public static TheoryData<MonetaryValue, MonetaryFrequency, MonetaryValue, string> ShouldConvertToDifferentFrequencyTheoryData =>
        new()
        {
